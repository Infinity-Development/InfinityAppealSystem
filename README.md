...
Follow the Steps and Information provided in our OSS Documentation listed below.

- [Intro](https://oss.botlist.site/appeals/@intro/)
- [Setup](https://oss.botlist.site/appeals/hosting/)
- [Config](https://oss.botlist.site/appeals/setup/)
