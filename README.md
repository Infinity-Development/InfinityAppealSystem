...
<p>In the project directory, you can run: <code>yarn start</code> Which runs the app in the development mode. Open <a href="http://localhost:3000">localhost:3000</a> to view it in the browser.
<br />
